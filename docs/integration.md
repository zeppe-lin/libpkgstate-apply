...
Link `libpkgstate-apply` only at the composition point that must cross this exact authority boundary. The adapter returns immutable values and performs no hidden I/O.
